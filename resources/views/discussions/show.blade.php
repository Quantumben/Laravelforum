   ...
   @include('partials.discussion-header')
    ...
    <div class="card-body">
      ...
      <div class="text-center">
        ...
        <div class="card bg-success my-5" style="color: #ffff">
...
<div class="card my-5">
    <div class="card-header">
        <div class="d-flex justify-content-between">
            <div>
                <img width="40px" height="40px" style="border-radius:100%" src="{{Gravatar::src($reply->owner->email)}}" alt="">
...
<div class="card-body">
    ...
    @else
    <a href="{{route('login')}}"  style="width:100%" class="btn btn-sm my-2btn-info">Login To Reply</a>
    @endauth
</div>
