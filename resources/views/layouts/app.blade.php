       ...
       @if (!in_array(request()->path(), ['login','password/email', 'password/reset']))
            <main class="container py-4">
                ...
                <div class="row">
                    <div class="col-md-4">
                    @auth
                    <a href="{{route('discussion.create')}}" style="width:100%; color:#ffff" class="btn btn-info my-2">Add Discussion</a>
                        @else
                        <a href="{{route('login')}}" style="width:100%; color:#ffff" class="btn btn-info my-2">Register/Login</a>
                    @endauth
                    <div class="card">
